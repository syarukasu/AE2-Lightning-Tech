...
/** Formation binding for a Matrix pattern bay; pattern inventory is a later bridge. */
public final class MatrixPatternStorageBlockEntity extends BlockEntity {
    private static final String TAG_CONTROLLER = "MatrixController";
    @Nullable
    private BlockPos controllerPos;

    public MatrixPatternStorageBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.MATRIX_PATTERN_STORAGE.get(), pos, state);
    }
